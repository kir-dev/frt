        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <button
              ...
              className={`flex items-center px-3 py-2 font-bold transition-colors outline-none border-0 shadow-none rounded-lg 
                                ${
                                  theme === "dark"
            ...
            >
              <div
                className={`w-10 h-10 flex items-center justify-center font-bold rounded-lg mr-2 hover:bg-red-400
                                ${
                                  theme === "dark"
                                    ? "!text-white"
                                    : "!text-white"
      ...
      >
        <div className="container mx-auto px-4 py-2">
          ...
          <div className="mt-2 flex flex-row gap-2 items-center">
            ...
            <button
              onClick={toggleLanguage}
              className={`flex items-center px-3 py-2 font-bold transition-colors outline-none border-0 shadow-none
                                ${
                                  theme === "dark"
            ...
            >
              <div
                className={`w-8 h-8 flex items-center justify-center font-bold rounded-lg mr-2
                                ${
                                  theme === "dark"
